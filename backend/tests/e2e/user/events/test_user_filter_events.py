...
def _login(page: Page):
    ...
    login_form.locator('input[placeholder="Introduceți adresa de email"]').fill("test2@gmail.com")
    slow(page, 250)
...
# Funcție pentru setarea valorii unui input prin JS
...
def test_search_filter_and_reset(page: Page):
    ...
    # Verificare inițială: cel puțin un card de eveniment este vizibil
    ...
    # setează valoarea căutării prin JS (cea mai stabilă metodă)
    ...
    # golește inputul căutare (prin JS)
    ...
    # Verificare: inputul Locație este gol
    loc_input2 = page.locator('input[placeholder^="Ex: Aula"]').first
